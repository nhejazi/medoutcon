...
#'   are in the order specified by the NPSEM (Y, M, Z, S, A, W), with column
...
#'   measured. These weights should only be provided if \code{S} is is
...
#' @param plugin_est A \code{numeric} representing the plug-in estimate for the
#'   given contrast.
#'
...
two_phase_eif <- function(S,
  ...
  ipw_two_phase <- S * two_phase_weights
