...
```{r remove_na, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r npsem, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r delta_ipsi, message=FALSE, warning=FALSE, eval=FALSE}
delta_shift_ipsi <- 3
```
...
```{r make_sl, message=FALSE, warning=FALSE, eval=FALSE}
